...
import './index.css';
import profilePhoto from "./assets/lige.jpg";
...
const PERSONAL_DATA = {
  ...
  experience: [
    {
      ...
      location: 'New Haven, USA; Remote, China',
      description: 'Worked on Multi-Modal time series prediction.'
    },
    {
      role: 'Research Assistant',
      company: 'DKU BioInfo Lab',
      period: '2023 - 2025',
      location: 'Kunshan, China',
      description: 'Worked on drug discovery, AI agent, and multi-omics analysis.'
    },
    {
      role: 'Research Assistant',
      company: 'DKU ML Lab',
  ...
  publications: [
      ...
      items: [
        {
          ...
          venue: 'ArXiv',
          status: 'Under Review',
          link: 'https://arxiv.org/abs/2601.21547',
    ...
    },
    {
      ...
      items: [
        {
          title: 'Exploring Intrinsic Structures of Hyperedges as Point Clouds',
          authors: 'Zhang, Lige., Zou, Dongmian.',
          venue: 'LoG | Learning on Graphs Conference (Extended Abstract Track)',
          status: 'Published (Selected as Oral Presentation)',
          link: '#',
          code: '#'
        }
      ]
      ...
      items: [
        {
          ...
          authors: 'Qu, Eric.*, Zhang, Lige.*, Debaya, Habib., Wu, Yue., Zou, Dongmian.',
          venue: 'LoG | Learning on Graphs Conference',
          status: 'Published',
          link: 'https://openreview.net/forum?id=38SRU0BwXk&noteId=38SRU0BwXk',
          code: 'https://github.com/BruceZhangReve/Hyperbolic-Kernel-Convolution'
        },
      ]
    }
  ],
  projects: [
    {
      title: 'A unified approach for drug target identification and antiviral screening',
      description: 'Patent (ID:CN119223924A)',
      technologies: ['PAML', 'AlphaFold'],
      github: '#',
      demo: '#',
      status: 'Active'
    },
      {
      title: 'A method for screening drugs for monkeypox viruses',
      description: 'Patent (ID:CN119479779A)',
      technologies: ['PAML', 'AlphaFold'],
      github: '#',
      demo: '#',
      status: 'Active'
  ...
  news: [
    {
      date: 'March 2025',
      content: 'Admitted by Emory University!'
    },
  ],
  teaching: [
    {
