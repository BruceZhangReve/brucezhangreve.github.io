...
const PERSONAL_DATA = {
  name: 'Lige Zhang',
  title: 'Incoming PhD Student | Machine Learning Researcher',
  bio: 'I am a passionate researcher focusing on Geometric Deep Learning, Time Series Analysis, and AI for Healthcare. My work bridges theoretical advances with practical applications to solve real-world challenges.',
  researchInterests: [
  ...
  education: [
    {
      ...
      description: 'Graduated summa cum laude. Thesis on "Graph Neural Networks for Multivariate Time Series Forecasting".'
    },
    {
      ...
      description: 'Seeking PhD opportunities in top ML programs.'
    }
  ],
  experience: [
    {
      role: 'Research Intern',
      company: 'Microsoft Research AI',
      period: 'Summer 2024',
      location: 'Remote',
    ...
    },
    {
      ...
      period: '2022 - 2024',
      location: 'Kunshan, China',
      description: 'Led project on time series anomaly detection using self-supervised learning.'
    }
  ],
  publications: [
    {
